...
mixin MessageStateMixin {
  ...
  String? get infoMssage => _infoMessage();

  final Signal<String?> _successMessage = signal(null);
  String? get successMssage => _successMessage();
  ...
  void messageListener(MessageStateMixin state) {
    effect(() {
      switch (state) {
        ...
        case MessageStateMixin(:final infoMssage?):
          Messages.showInfo(infoMssage, context);
        case MessageStateMixin(:final successMssage?):
          Messages.showSuccess(successMssage, context);
      }
    });
  }
}
